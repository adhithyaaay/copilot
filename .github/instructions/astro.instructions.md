...
- Define a `Props` interface in frontmatter for every component, including pages that accept props
- Document reusable component `Props` interfaces with a short TSDoc comment describing the component contract, each prop, and any default or optional behavior
...
- Comment why a component needs non-obvious markup or behavior; do not narrate obvious HTML or Tailwind classes. Keep comments current when the component changes.
